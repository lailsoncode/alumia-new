...
- módulos ativos da home agrupados em uma única superfície, com ícone de seção sem fundo, opções compactas em duas colunas, edição no rodapé e raios contidos de 20 px no bloco e 14 px nas opções.
