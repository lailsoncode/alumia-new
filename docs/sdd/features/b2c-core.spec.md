...
Os critérios `B2C-TSK-AC-01` a `B2C-TSK-AC-15` estão na especificação detalhada. Eles verificam, entre outros casos, terça e quinta como duas ocorrências semanais, ausência de duplicidade, mudança de fuso, série ativa até desativação, lembrete sempre vinculado a uma data, controles em linha no mobile, avisos e isolamento dos dados.
