...
export function InfoCard({ children }: { children: ReactNode }) {
  return (
    <section className="flex items-center gap-3 rounded-[1.5rem] border border-primary/20 bg-primary/10 px-4 py-3.5 text-foreground shadow-[var(--shadow-card)] sm:px-5">
