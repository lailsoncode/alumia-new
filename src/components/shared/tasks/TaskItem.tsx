...
export function TaskItem({ task, onToggle }: TaskItemProps) {
  ...
  return (
    <li data-module={moduleKey} className={`${moduleTheme.themeClass} module-border flex min-h-16 items-center gap-2.5 rounded-[1.125rem] border bg-surface p-2.5 shadow-[var(--shadow-card)] transition-transform hover:-translate-y-0.5 ${task.done ? "opacity-65" : ""}`}>
