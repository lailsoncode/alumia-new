...
export function TaskItem({ task, onToggle }: TaskItemProps) {
  ...
  return (
    <li className={`flex min-h-20 items-center gap-3 rounded-[1.4rem] border border-border/80 bg-surface p-3.5 shadow-[var(--shadow-card)] transition-transform hover:-translate-y-0.5 ${task.done ? "opacity-65" : ""}`}>
