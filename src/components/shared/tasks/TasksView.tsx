...
export function TasksView() {
  ...
  return (
    <section>
      ...
      <Surface className="mt-6 flex items-start gap-4 p-5 sm:p-6">
      ...
      <div className="mt-7 flex gap-2 rounded-[1.4rem] bg-muted/80 p-1.5" role="tablist" aria-label="Período das tarefas">
      ...
      {loading ? (
        ...
        <div className="mt-8 grid gap-8 xl:grid-cols-2">{sections.map((section) => (
          <section key={section.title} className={section.title === "Pode esperar" ? "xl:col-span-2" : undefined}>
            ...
            {section.tasks.length ? (
              ...
              <Surface variant="subtle" className="px-5 py-7 sm:px-6">
